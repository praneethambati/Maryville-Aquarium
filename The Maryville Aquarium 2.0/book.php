...
<html>
	<head>
        ...
        <link rel="stylesheet" href="css/style_popup.css"> <!-- CSS Popup -->
	</head>
							...
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li><a href="404.html">School Trips</a></li>
									</ul>
								</li>
						...
						<article id="main" class="special">	
                                <section>
                                    ...
                                    <ol class="cd-multi-steps text-center custom-icons">
                                        <li id="pg1" class="current"><a href="book.php">Select Tickets</a></li>
                                        <li id="pg2"><a href="book02.html">...And More!</a></li>
                                ...
                                <!-- <div style="margin-left:29em;">
                                 ...
                                 <div class="style1">
									...
									<!--onclick="book02.html"-->
									<a href="book02.html"><button id="next-button" style="margin-left: 10em;" onclick="book02.html type="submit" value="Next" >Next</button></a>
                                 </div>
								 </form>
                           	</section>
					  </article>
